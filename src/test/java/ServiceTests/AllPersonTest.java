...
public class AllPersonTest {
    ...
    public void setUp() throws Exception {
        try
        {
            ...
            request = new AllPersonRequest(bobbyAuth);
            service = new AllPersonService();

            posExpected = new Person[] {bobbyPerson, brucePerson};
    ...
    public void negServiceTest() {
        request = new AllPersonRequest(new AuthToken("qwerty","bobby"));
        AllPersonResult result = service.service(request);
