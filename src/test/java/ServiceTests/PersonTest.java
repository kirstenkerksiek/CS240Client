...
public class PersonTest {
    ...
    public void setUp() throws Exception {
        try
        {
            ...
            request = new PersonRequest(abbyAuth, allyPerson.getPersonID());
            service = new PersonService();

            posExpected = allyPerson;
    ...
    public void posServiceTest() throws Exception {
        ...
        assertEquals(posExpected, result.getPerson());
    }

    @Test
    public void negServiceTest() {
        request = new PersonRequest(new AuthToken("qwerty","abby"), posExpected.getPersonID());
        PersonResult result = service.service(request);
        assertNotNull(result.getMessage());
        assertFalse(result.isSuccess());

        request = new PersonRequest(new AuthToken("12345","abby"), "badPersonID");
